...
from torchvision.transforms.v2 import Compose, Grayscale, ToTensor, Lambda
...
if __name__ == '__main__':
    ArgParser()
    # argparse = argparse.ArgumentParser("setting train parameters")
    #
    # argparse.add_argument("-e", "--epochs", type=int, default=36, help="number of training epochs")
    # argparse.add_argument("-b", "--batch_size", type=int, default=64, help="batch")
    # argparse.add_argument("-d", "--cuda", type=int, default=None, help="使用cuda的设备号")
    #
